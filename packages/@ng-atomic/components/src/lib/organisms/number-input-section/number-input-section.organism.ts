...
@TokenizedType()
@Directive({ standalone: true, selector: 'organisms-number-input-section' })
export class NumberInputSectionOrganismStore extends InjectableComponent {
...
@Component({
  selector: 'organisms-number-input-section',
  standalone: true,
  imports: [
  ...
  `,
  styleUrl: './number-input-section.organism.scss',
...
export class NumberInputSectionOrganism extends NgAtomicComponent {
  protected store = inject(NumberInputSectionOrganismStore);
}
