...
describe('standarization', () => {
  it('', () => {
    expect(standarization(
      '/ng-atomic/example/src/lib/domain/models/first-model.ts',
      '/ng-atomic/example/src/lib/domain/models/second-model.ts',
    )).toEqual([
      '/0/1/2/3/4/5/6.7',
      '/0/1/2/3/4/5/8.7',
    ])
...
describe('calculateDistance()', () => {
  ...
  it('', () => {
    expect(calculateDistance(
      '/ng-atomic/example/src/lib/domain/models/first-model.component.ts',
      '/ng-atomic/example/src/lib/domain/models/second-model.module.ts',
    )).toEqual(2)
  });
});
